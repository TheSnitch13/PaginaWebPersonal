function  calcularRecipiente() {
    ...
    let nivel = parseFloat( document.querySelector('#Nivel').value);
    let densidad = parseFloat( document.querySelector('#Densidad').value);
    UTS = 0;
    Ys  = 0;
    ...
    Vliquido = (Math.PI*longitud)*(Math.pow(diametro,2))*(nivel/diametro)/4;
    pesoliquido = densidad * Vliquido;
    ...
    document.querySelector('#pesooperacion').value = (pesoVacio + pesoliquido).toFixed(0);
